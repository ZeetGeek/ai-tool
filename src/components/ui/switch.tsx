...
const Switch = React.forwardRef<React.ElementRef<typeof SwitchPrimitives.Root>, React.ComponentPropsWithoutRef<typeof SwitchPrimitives.Root>>(({ className, ...props }, ref) => (
	<SwitchPrimitives.Root
		...
		ref={ref}
	>
		<SwitchPrimitives.Thumb className={cn("switch_thumb pointer-events-none ms-0 block h-5 w-5 rounded-full bg-white shadow-lg ring-0 dark:ms-auto dark:bg-neutral-600")} />
	</SwitchPrimitives.Root>
));
